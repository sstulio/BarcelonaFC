...
public class MidFieldPlayer extends Thread {
	...
	public MidFieldPlayer(PlayerCommander player, int playerNumber) {
		commander = player;
...
//		System.out.println("TURN");
	...
	private boolean closeToNextPosition() {
		if (nextPosition.distanceTo(selfPerc.getPosition()) <= 10) {
			return true;
		}
		return false;
	}
